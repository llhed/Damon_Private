...
public class CommandsImpl implements Commands{
	...
	public byte[] CRCVerify(ByteBuffer bb){
        ...
        crcBytes[0] = (byte)Integer.parseInt(crcStr.substring(crcStr.length()-2, crcStr.length()), 16);
        crcBytes[1] = (byte)Integer.parseInt(crcStr.substring(crcStr.length()-4, crcStr.length()-2), 16);
